...
@ActiveProfiles("test")
public class ToggleTaskIsDoneControllerTest {
  ...
  @Test
  @DisplayName("Should be able to toggle the isDone property of a task")
  void shouldToggleIsDone() throws Exception {
    ...
    mvc.perform(
        MockMvcRequestBuilders.patch("/api/v1/tasks/" + task.getId() + "/is-done")
