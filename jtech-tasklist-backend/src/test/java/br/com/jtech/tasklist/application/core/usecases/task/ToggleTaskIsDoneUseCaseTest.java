...
import br.com.jtech.tasklist.config.usecases.task.ToggleTaskIsDoneUseCaseConfig;
...
public class ToggleTaskIsDoneUseCaseTest {

  @Mock
  TaskRepository repository;

  @InjectMocks
  ToggleTaskIsDoneAdapter adapter;

  ToggleTaskIsDoneUseCase useCase;

  @BeforeEach
  void setup() {
    this.useCase = new ToggleTaskIsDoneUseCaseConfig().useCase(adapter);
  }
